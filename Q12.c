...
int main()
{
	 ...
	 printf("%-20s %-15zu %-25s %-20e %-15e\n","Float ",sizeof(float),"%f / %e / %g / %E",FLT_MIN,FLT_MAX);
	 printf("%-20s %-15zu %-25s %-20e %-15e\n","Double ",sizeof(double),"%f / %e / %g / %E",DBL_MIN,DBL_MAX);
	 printf("%-20s %-15zu %-25s %-20Le %-15Le\n","Long Double ",sizeof(long double),"%Lf / %Le / %Lg / %LE",LDBL_MIN,LDBL_MAX);
